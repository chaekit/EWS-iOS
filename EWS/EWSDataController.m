...
-(void)initDefault
{
    ...
    Lab *lab4 = [[Lab alloc] initWithName:@"EH 406B1" Capacity:40 Building:@"EH" Platform:@"Linux"];
    Lab *lab5 = [[Lab alloc] initWithName:@"EH 406B8" Capacity:40 Building:@"EH" Platform:@"Linux"];
    ...
    Lab *lab8 = [[Lab alloc] initWithName:@"GELIB 4th" Capacity:39 Building:@"GE" Platform:@"Linux"];
    ...
    Lab *lab13 = [[Lab alloc] initWithName:@"SIEBL 0222" Capacity:21 Building:@"SIEBL" Platform:@"Linux"];
